...
import com.uetm.loginregisterretrofit.Response.LoginUserResponse;
...
public class LoginActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<LoginUserResponse> call, Response<LoginUserResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        Log.i("onSuccess", response.body().loginBean.getEmail());
                        userid = response.body().loginBean.user_id;
                        useremail = response.body().loginBean.email;
                        userfname = response.body().loginBean.first_name;
                        userlname = response.body().loginBean.last_name;
                        try {
                            parseLoginData();
                        } catch (Exception e) {
                            e.printStackTrace();
    ...
    private void parseLoginData() {
        try {
            ...
            Intent intent = new Intent(LoginActivity.this, ProfieActivity.class);
