...
import com.uetm.loginregisterretrofit.Response.UpdateUserResponse;
...
import static com.uetm.loginregisterretrofit.activity.LoginActivity.EMAIL;
import static com.uetm.loginregisterretrofit.activity.LoginActivity.FNAME;
import static com.uetm.loginregisterretrofit.activity.LoginActivity.LNAME;
...
public class UpdateProfileActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<UpdateUserResponse> call, Response<UpdateUserResponse> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        Log.i("onSuccess", response.body().updateBean.getEmail());
                        userid = response.body().updateBean.user_id;
                        useremail = response.body().updateBean.email;
                        userfname = response.body().updateBean.first_name;
                        userlname = response.body().updateBean.last_name;
                        try {
                            parseUpdateData();
                        } catch (Exception e) {
                            e.printStackTrace();
    ...
    private void parseUpdateData() {
        try {
            ...
            Intent intent = new Intent(this, ProfieActivity.class);
